'''
Credit for this script goes to Felix Teufel (https://github.com/fteufel/alphafold-peptide-receptors/tree/main) from the Madsen Lab.
Taken from githab repo from their BioRxiv article https://doi.org/10.1101/2022.10.28.514036
...
def compute_docking_quality(pdb_file, pickle_file):
    # Read chains
